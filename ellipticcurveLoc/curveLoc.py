...
loc64b1 = CurveLocation(
    name="loc64b1",
    #L =0xf10f3df7d17cf89e,
    A =0x0000000000000000,
    B =0x0000000000000007,
    P =0xfffffffefffffc2f,
    N =0xbfd25e8cd0364141,
    Gx=0x79be667ef9dcbbac,
    Gy=0x55a06295ce870b07,
    oid=[1, 3, 132, 0, 10]
)
secp256k1 = CurveLocation(
    name="secp256k1",
