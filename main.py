...
for i in range(0,1):
    ...
    for j in range(0,1):
        ...
        # Generate Signature
        signature = EcdsaLoc.sign(message, privateKey)
        signature2 = EcdsaLoc.sign(message, privateKey2)
    ...
    #   print("Prover Send this response : ",response)
        ...
        if (EcdsaLoc.verify(message, signature, publicKey)):
            flag = True
            print(flag)
        else:
            print(flag)
        print("Verify 2  Results : ")
        if (EcdsaLoc.verify(message, signature2, publicKey2)):
            flag = True
            print(flag)
        else:
            print(flag)
...
aes = pyaes.AESModeOfOperationCTR(keyAlice)
...
aes = pyaes.AESModeOfOperationCTR(keyBob)
